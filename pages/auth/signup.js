                ...
                <div className="rounded-md border border-neutral-200 shadow-md mt-12">
                    <div className="p-4">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col space-y-2">
                            ...
                            <input className="p-2 rounded border-2 border-neutral-100 focus:outline-2 focus:outline-neutral-500" type="password" placeholder="Password confirmation" ref={passwordConfirmRef} />
