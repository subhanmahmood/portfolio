  ...
  return (
    <MainLayout className="font-display flex flex-col-reverse md:flex-col items-center min-h-screen">
      ...
      <section className="w-full px-4 md:px-0">
        <div className="-mb-48 shadow-xl relative w-full md:max-w-screen-md mx-auto rounded-xl grid grid-cols-1 md:grid-cols-2 mt-48" >
          <div className="bg-neutral-500"></div>
          <div className="flex flex-col gap-y-4 p-12 max-w-sm bg-gray-200">
