                    ...
                    <div className="flex justify-between w-full">
                        ...
                        <div className="hidden md:flex flex-row items-center space-x-12">
                            <Link href="https://twitter.com/subhanmahmoood" target="none">
                                <FaTwitter className="text-white hover:text-stone-400 h-7 cursor-pointer" />
                            </Link>
                            <Link href="https://instagram.com/subhan.mahmoood" target="none">
                                <FaInstagram className="text-white hover:text-stone-400 h-7 cursor-pointer" />
                            </Link>
                            <Link href="https://linkedin.com/in/subhanmahmood" target="none">
                                <FaLinkedinIn className="text-white hover:text-stone-400 h-7 cursor-pointer" />
                            </Link>
                            <Link href="https://www.tiktok.com/@subhan.mahmood?" target="none">
                                <FaTiktok className="text-white hover:text-stone-400 h-7 cursor-pointer" />
                            </Link>
                        </div>
                    </div>
                </div>
