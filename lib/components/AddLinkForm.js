        ...
        <OutsideClickWrapper onOutsideClick={onOutsideClick}>
            {
                adding ?
                    (
                        <div className="p-4 rounded-md border border-neutral-200 shadow-md flex flex-row justify-between mt-4">
                        ...
                        <div onClick={() => setAdding(true)} className="mt-4 h-16 rounded-md border text-neutral-200 border-neutral-200 flex justify-center items-center cursor-pointer">
